...
# Load score CSVs
pwm_df = pd.read_csv("PWM_Risk_Scores.csv")
decoder_df = pd.read_csv("Q_Decoder_Risk_Scores.csv")
filter_df = pd.read_csv("Image_Filter_Risk_Scores.csv")
control_df = pd.read_csv("Control_Loop_Risk_Scores.csv")
